...
function CartPage() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-16">
      <h1 className="mb-10 text-4xl font-bold text-zinc-900">Shopping Cart</h1>
      ...
      {cartItems.length === 0 ? (
        ...
        <div className="space-y-6">
          {cartItems.map((item) => (
            <div
              key={item.id}
              className="flex flex-col gap-6 rounded-3xl bg-white p-6 shadow-sm md:flex-row md:items-center md:justify-between"
            >
